...
from sqlalchemy_auth_hooks.oso.sqlalchemy_oso.preprocess import preprocess, preprocess_expression
...
def test_preprocess_nested_many_many():
    ...
    users_expr = Expression("And", [Expression("Unify", ["admin", Expression("Dot", [_this, "username"])])])
    tags_expr = Expression("And", [Expression("In", [users_expr, Expression("Dot", [_this, "users"])])])
